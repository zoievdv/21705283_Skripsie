...
# Load the Excel file
file_path = os.path.join(current_dir,'topic_similarities.xlsx')
df = pd.read_excel(file_path, sheet_name='Sheet1')

# Load the Labelled_topics.csv for matching Topic_Labels
labelled_topics_path = os.path.join(current_dir,'Labelled_topics.csv')
...
html_file = "Dashboard html/concentric_radial_spider_map_with_highlights.html"
